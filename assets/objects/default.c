...
Sprite pineapple;
Sound sound;
char* tex_filepath = "/Users/user/Desktop/baphomet/assets/images/pineapple.png";
char* snd_filepath = "/Users/user/Desktop/baphomet/assets/audio/the-legendary-hero.ogg";
float x, y = 0.0f;
float run_spd = 0.02f;
int hspeed, vspeed;
